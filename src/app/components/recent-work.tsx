...
const projects = [
  {
    ...
    skills: ['HTML5', 'CSS3', 'SaSS', 'JavaScript', 'TypeScript', 'React', 'Redux', 'AntD', 'Node', 'Feather', 'PostgreSQL'],
      ...
      {projects.map((project) => (
        <div key={project.id} className='mt-10 w-full overflow-hidden rounded-lg border shadow-md'>
          <div className='image-container w-full'>
            <Image src={project.img} alt={project.title} layout='fill' className='image border-b' loading='lazy' />
          </div>
          <div className='p-5'>
